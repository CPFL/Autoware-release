## Autoware (kinetic) - 1.4.0-1

The packages in the `Autoware` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic Autoware --edit` on `Sat, 05 Aug 2017 22:17:11 -0000`
...
## repository_name (kinetic) - 1.4.0-0
